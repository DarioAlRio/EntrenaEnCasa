...
function icon(name, cls) {
  ...
  const icons = {
    ...
    dumbbell: `<svg class="icon${extra}" viewBox="0 0 24 24" width="22" height="22" aria-hidden="true"><path d="M4 10v4M2 9v6M20 10v4M22 9v6M7 12h10" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/><rect x="5" y="8" width="3" height="8" rx="1" fill="none" stroke="currentColor" stroke-width="1.6"/><rect x="16" y="8" width="3" height="8" rx="1" fill="none" stroke="currentColor" stroke-width="1.6"/></svg>`,
    mat: `<svg class="icon${extra}" viewBox="0 0 24 24" width="22" height="22" aria-hidden="true"><rect x="3" y="6" width="18" height="12" rx="3" fill="none" stroke="currentColor" stroke-width="1.6"/><path d="M8 6v12M13 6v12" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/></svg>`,
    band: `<svg class="icon${extra}" viewBox="0 0 24 24" width="22" height="22" aria-hidden="true"><path d="M5 6c6 0 8 12 14 12M5 18c6 0 8-12 14-12" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/></svg>`,
    bench: `<svg class="icon${extra}" viewBox="0 0 24 24" width="22" height="22" aria-hidden="true"><rect x="3" y="9" width="18" height="5" rx="1.5" fill="none" stroke="currentColor" stroke-width="1.6"/><path d="M6 14v4M18 14v4" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/></svg>`,
    jumprope: `<svg class="icon${extra}" viewBox="0 0 24 24" width="22" height="22" aria-hidden="true"><circle cx="5" cy="6" r="2" fill="none" stroke="currentColor" stroke-width="1.6"/><circle cx="19" cy="6" r="2" fill="none" stroke="currentColor" stroke-width="1.6"/><path d="M5 8c0 8 14 4 14 12" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/></svg>`,
  };
  return icons[name] || "";
}
