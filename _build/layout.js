...
function headerHtml(path) {
  ...
  <header class="site-header">
    <div class="wrap header-inner">
      <a class="logo" href="/">
        <span class="logo-mark" aria-hidden="true">${icon("dumbbell")}</span>
      ...
      <div class="foot-grid">
        <div class="foot-brand">
          ...
          <p class="foot-contact">
            ${icon("mail")}
            <a href="#" class="js-mail" data-correo="hola|entrenaencasa.es">activar JavaScript para ver el correo</a>
          </p>
        </div>
        ${columnas}
      </div>
...
function pageHero({ eyebrow, title, dek, updated, image, imageAlt }) {
  return `<section class="page-hero">
    <div class="wrap${image ? " page-hero-wrap-img" : ""}">
      ...
      ${image ? `<img class="page-hero-img" src="${image}" alt="${escapeHtml(imageAlt || "")}" loading="lazy" width="480" height="320">` : ""}
    </div>
  </section>`;
}
...
function ctaBand() {
  return `<section class="cta-band">
    <div class="wrap">
      ...
      <p>Empieza por la guía del equipo que más te preocupe ahora mismo: mancuernas, esterilla o bandas elásticas.</p>
