...
function guiasIndex() {
  ...
  ${pageHero({
    ...
    dek: "Criterios para elegir cada tipo de equipamiento de fitness en casa, sin recomendar una marca concreta.",
  })}
  ...
  return {
    ...
    description: "Todas las guías de compra de EntrenaEnCasa: mancuernas, esterillas, bandas elásticas, banco de entrenamiento y accesorios de cardio.",
