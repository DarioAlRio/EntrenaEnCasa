...
// decorativo): mismo orden que las guías principales, sin "accesorios de
// cardio" porque el hero solo tiene sitio para 4 tarjetas.
const HERO_LABELS = {
  "mancuernas-ajustables": "Mancuernas",
  "esterillas-yoga": "Esterilla",
  "bandas-elasticas": "Bandas",
  "banco-entrenamiento": "Banco",
};
  ...
  <section class="hero">
    <div class="wrap hero-inner">
      <div class="hero-copy">
        ...
        <h1>${SITE.claim}</h1>
        <p class="hero-dek">
          Comparamos criterios, no marcas: qué mirar antes de comprar mancuernas, una esterilla,
          bandas elásticas o un banco de entrenamiento, explicado sin tecnicismos y sin
