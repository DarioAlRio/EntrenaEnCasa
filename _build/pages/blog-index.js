...
function blogIndex() {
  ...
  ${pageHero({
    eyebrow: "Blog",
    title: "Blog",
    dek: "Notas más cortas sobre entrenamiento, material y rutinas para casa, entre guía y guía.",
  })}
  ...
  return {
    ...
    path: "/blog/",
    title: "Blog",
    description: "Artículos sobre entrenamiento, material y rutinas de fitness en casa de EntrenaEnCasa.",
